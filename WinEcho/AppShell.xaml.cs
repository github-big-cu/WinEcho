...
namespace WinEcho
{
    ...
    public sealed partial class AppShell : Page
    {
          ...
          new[]
            {
                ...
                new NavMenuItem()
                {
                    Symbol = Symbol.Memo,
                    Label = "Echo Tap",
                    DestPage = typeof(EchoPage)
                },
                new NavMenuItem()
                {
                    Symbol = Symbol.Send,
                    Label = "Login to Amazon",
                    DestPage = typeof(AmazonLogin)
                },
            });
        ...
        public void OpenNavePane()
        {
            ...
            echotext.Visibility = Visibility.Visible;
        }
        ...
        private void RootSplitView_PaneClosed(SplitView sender, object args)
        {
            ...
            echotext.Visibility = Visibility.Collapsed;
        }
