...
namespace WinEcho
{
        ...
        global::Windows.UI.Xaml.Markup.IComponentConnector2
    {
        ...
        private class AppShell_obj2_Bindings :
            ...
            IAppShell_Bindings
        {
            private global::WinEcho.NavMenuItem dataRoot;
            ...
            {
                 global::WinEcho.NavMenuItem data = args.NewValue as global::WinEcho.NavMenuItem;
                 if (args.NewValue != null && data == null)
                 {
                    throw new global::System.ArgumentException("Incorrect type passed into template. Based on the x:DataType global::WinEcho.NavMenuItem was expected.");
                 }
            ...
            public int ProcessBindings(global::Windows.UI.Xaml.Controls.ContainerContentChangingEventArgs args)
            {
                ...
                switch(args.Phase)
                {
                    case 0:
                        nextPhase = -1;
                        this.SetDataRoot(args.Item as global::WinEcho.NavMenuItem);
                ...
                this.Update_((global::WinEcho.NavMenuItem) args.Item, 1 << (int)args.Phase);
                return nextPhase;
            }
            ...
            public void SetDataRoot(global::WinEcho.NavMenuItem newDataRoot)
            {
                this.dataRoot = newDataRoot;
            }

            // Update methods for each path node used in binding steps.
            private void Update_(global::WinEcho.NavMenuItem obj, int phase)
            {
                if (obj != null)
                {
        ...
        public void Connect(int connectionId, object target)
        {
            ...
            case 8:
                {
                    this.NavMenuList = (global::WinEcho.Controls.NavMenuListView)(target);
                    #line 99 "..\..\..\AppShell.xaml"
                    ((global::WinEcho.Controls.NavMenuListView)this.NavMenuList).ContainerContentChanging += this.NavMenuItemContainerContentChanging;
                    #line 102 "..\..\..\AppShell.xaml"
                    ((global::WinEcho.Controls.NavMenuListView)this.NavMenuList).ItemInvoked += this.NavMenuList_ItemInvoked;
                    #line default
                }
                break;
            case 9:
            ...
            case 12:
                {
                    this.logoutPaneButton = (global::Windows.UI.Xaml.Controls.Button)(target);
                }
                break;
            case 13:
                {
                    this.SettingsNavPaneButton = (global::Windows.UI.Xaml.Controls.Button)(target);
                    #line 126 "..\..\..\AppShell.xaml"
            ...
            case 2:
                {
                    ...
                    bindings.SetDataRoot((global::WinEcho.NavMenuItem) element2.DataContext);
